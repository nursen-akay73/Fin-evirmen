...
SYSTEM_PROMPT = (
    ...
    "Bağlam terim sözlüğü, resmi mevzuat (6502 sayılı Kanun, TCMB 2020/7 tebliği), "
    "sözleşme maddesi rehberi, tüketici rehberi "
    "veya kullanıcının eklediği terim, belge ve görüntülerden gelebilir. "
    "Resmi mevzuat parçası varsa cevabı 📌 Yasal Dayanak satırıyla bitir; madde numarası uydurma. "
...
SYSTEM_PROMPT_EN = (
    ...
    "Context may come from a glossary, official statutes (Law 6502, CBRT communiqué 2020/7), "
    "a contract-clause guide, consumer guide, "
    "or terms, documents and images the user added. "
    "If statute passages are present, end with 📌 Legal basis; do not invent article numbers. "
