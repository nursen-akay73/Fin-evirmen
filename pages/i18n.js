(function (root) {
  ...
  var STRINGS = {
    tr: {
      ...
      "doc.title.kb": "Kişisel doküman ve bilgi kütüphanesi — FinÇevirmen",
      ...
      "story.steps.eyebrow": "Üç adım",
      "story.steps.lede":
        "Genel bir sohbet modeli değil: sorunuzu veya belgenizi alır, resmi kaynakta arar, sade Türkçe ve risk notuyla döner.",
      "story.step1.t": "Sorunu sor veya belgeni yükle",
      "story.step1.p": "Mikrofon, yazı veya PDF. Girdi sizin; sistem ezberlemez.",
      "story.step2.t": "Resmi mevzuat ve belge taraması",
      "story.step2.p":
        "Doğrulanmış RAG motoru sözlük, BDDK metni ve yüklediğiniz sözleşmeyi tarar.",
      "story.step3.t": "Sade Türkçe ve risk analiz raporu",
      "story.step3.p":
        "Kaynaklı, uydurmasız sonuç. Kritik maddeler risk etiketiyle öne çıkar.",
      "story.arch.summary": "Teknik mimariyi incele (geliştiriciler için)",
      ...
      "kb.title": "Kişisel doküman ve bilgi kütüphanesi",
      "kb.hint":
      ...
      "kb.dropHint": "Sürükleyip bırakın veya tıklayın",
      "kb.queue.wait": "Sırada",
      "kb.queue.busy": "İşleniyor",
      "kb.queue.done": "Eklendi",
      "kb.queue.fail": "Hata",
      ...
      "glossary.sheet.close": "Kapat",
      "glossary.sheet.legal": "Yasal referans",
      "glossary.sheet.home": "Ana sayfada sor",
      ...
      "topic.penalty": "Ceza",
      "chip.min": "Ekstredeki asgari tutarı ödersem ne kadar faiz biner?",
      "chip.fee": "Kredi kartı aidatı yasal mı, nasıl iptal edilir?",
      "chip.early": "Konut kredisinde erken ödeme cezası var mı?",
      "chip.withdraw": "Kredide cayma hakkı kaç gündür?",
      "contract.tab": "Sözleşme oku",
      "statement.tab": "Ekstre / dekont tara",
      "statement.title": "Ekstre ve dekont tarayıcı",
      "statement.hint": "Kredi kartı ekstresi PDF veya fotoğraf yükleyin. Gizli masraf ve aidat satırları işaretlenir.",
      "statement.file": "PDF veya görüntü seçin",
      "statement.submit": "Tara",
      "statement.busy": "Taranıyor...",
      "statement.ready": "Anomali taraması tamamlandı.",
      "export.pdf": "PDF raporu indir",
      "export.share": "Bağlantıyı paylaş",
      "export.copied": "Bağlantı panoya kopyalandı. 30 dakika geçerli.",
      "export.empty": "Önce bir karşılaştırma üretin.",
      "export.filename": "fincevirmen-karsilastirma.pdf",
      "export.shared": "Paylaşılan karşılaştırma",
      "export.expired": "Bu bağlantının süresi dolmuş.",
      "petition.cta": "Aleyhte bir madde göründü. Kaynaklı bir itiraz taslağı üretebilirsiniz.",
      "petition.button": "Bu madde için resmi itiraz dilekçesi üret",
      "petition.short": "Dilekçe üret",
      "petition.badge": "Taslak · hukuki tavsiye değil",
      "petition.title": "İtiraz dilekçesi",
      "petition.bank": "Banka adı",
      "petition.bankPh": "Örn. X Bankası",
      "petition.province": "İl",
      "petition.provincePh": "İl seçin",
      "petition.place": "İlçe kaymakamlığı",
      "petition.placePh": "İlçe seçin",
      "petition.placeFirst": "Önce il seçin",
      "petition.placeError": "İl ve ilçe listesi yüklenemedi. Sayfayı yenileyin.",
      "petition.date": "Tarih",
      "petition.build": "Taslağı oluştur",
      "petition.pdf": "PDF indir",
      "petition.ready": "Taslak hazır. İndirmeden önce okuyun.",
      "petition.previewHint": "Banka ve tarihi yazıp taslağı oluşturun.",
      "petition.filename": "fincevirmen-dilekce.pdf",
      "petition.topicDefault": "Kart aidatı / cayma hakkı",
    ...
    en: {
      ...
      "doc.title.kb": "Personal documents and knowledge library — FinÇevirmen",
      ...
      "story.steps.eyebrow": "Three steps",
      "story.steps.lede":
        "Not a general chatbot: it takes your question or document, searches official sources, and returns plain language with a risk note.",
      "story.step1.t": "Ask or upload your document",
      "story.step1.p": "Microphone, text or PDF. You provide the input; the system does not memorise it.",
      "story.step2.t": "Official regulation and document scan",
      "story.step2.p":
        "The verified RAG engine scans the glossary, BDDK texts and the contract you uploaded.",
      "story.step3.t": "Plain Turkish and a risk report",
      "story.step3.p":
        "A sourced, hallucination-free result. Critical clauses are flagged with risk labels.",
      "story.arch.summary": "Inspect the technical architecture (for developers)",
      ...
      "kb.title": "Personal documents and knowledge library",
      "kb.hint":
      ...
      "kb.dropHint": "Drag and drop or click to choose",
      "kb.queue.wait": "Queued",
      "kb.queue.busy": "Processing",
      "kb.queue.done": "Added",
      "kb.queue.fail": "Failed",
      "ph.term": "e.g. Default",
      ...
      "glossary.sheet.close": "Close",
      "glossary.sheet.legal": "Legal reference",
      "glossary.sheet.home": "Ask on the home page",
      ...
      "chip.min": "If I pay only the minimum on my statement, how much interest accrues?",
      "chip.fee": "Is a credit-card annual fee legal, and how do I cancel it?",
      "chip.early": "Is there an early-repayment penalty on a home loan?",
      "chip.withdraw": "How many days is the withdrawal right on a loan?",
      "contract.tab": "Read contract",
      "statement.tab": "Scan statement / receipt",
      "statement.title": "Statement and receipt scanner",
      "statement.hint": "Upload a credit-card statement PDF or photo. Hidden fees and annual charges are flagged.",
      "statement.file": "Choose PDF or image",
      "statement.submit": "Scan",
      "statement.busy": "Scanning...",
      "statement.ready": "Anomaly scan finished.",
      "export.pdf": "Download PDF report",
      "export.share": "Share link",
      "export.copied": "Link copied. Valid for 30 minutes.",
      "export.empty": "Run a comparison first.",
      "export.filename": "fincevirmen-comparison.pdf",
      "export.shared": "Shared comparison",
      "export.expired": "This link has expired.",
      "petition.cta": "An unfavourable clause appeared. You can generate a sourced objection draft.",
      "petition.button": "Generate an official objection letter for this clause",
      "petition.short": "Draft letter",
      "petition.badge": "Draft · not legal advice",
      "petition.title": "Objection letter",
      "petition.bank": "Bank name",
      "petition.bankPh": "e.g. Bank X",
      "petition.province": "Province",
      "petition.provincePh": "Choose a province",
      "petition.place": "District governor’s office",
      "petition.placePh": "Choose a district",
      "petition.placeFirst": "Choose a province first",
      "petition.placeError": "Province list could not be loaded. Refresh the page.",
      "petition.date": "Date",
      "petition.build": "Create draft",
      "petition.pdf": "Download PDF",
      "petition.ready": "Draft ready. Read it before downloading.",
      "petition.previewHint": "Enter the bank and date, then create the draft.",
      "petition.filename": "fincevirmen-petition.pdf",
      "petition.topicDefault": "Card fee / withdrawal right",
